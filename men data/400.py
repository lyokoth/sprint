...
url = 'https://worldathletics.org/records/toplists/sprints/400-metres/outdoor/men/senior/2023?regionType=world&timing=electronic&page=1&bestResultsOnly=true'
...
df.to_csv('400_Male.csv', index=False)